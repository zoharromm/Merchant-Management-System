...
namespace Crawler_Without_Sizes_Part2
{
    public static class CommanFunction
    {
        ...
        public static List<string> GetCategoryUrl(HtmlNodeCollection _Collection, string Findtag, string Format, string Domain, string Appendendurl)
        {
                    ...
                    if (_Node.Name == Findtag)
                    {
                        ...
                        foreach (HtmlNode _Node2 in _Collection1)
                        {
                            foreach (HtmlAttribute _Attribute in _Node2.Attributes)
                            {
                                ...
                                {
                                    _Urls.Add(Domain + _Attribute.Value + Appendendurl);
                                }
                            }
                        }
                    }
